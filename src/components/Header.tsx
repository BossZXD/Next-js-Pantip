  ...
  return (
    <header className="bg-[#53507c] p-4 flex items-center justify-between flex-wrap lg:flex-nowrap">
      <div className="flex items-center w-full lg:w-1/4 pl-6 mb-4 lg:mb-0">
        <Image src="/assets/images/logo-mobile-pantip-white.png" alt="Pantip Logo" width={60} height={60} />
        <span className="text-white text-xl lg:text-2xl pl-4 font-bold ml-2">Pantip</span>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex justify-center mb-4 lg:mb-0">
        <div className="relative w-full max-w-screen-2xl">
          ...
          />
          <Search className="absolute right-1 top-1/2 transform -translate-y-1/2 text-gray-100 bg-[#53507c] rounded-full p-1" size={35} />
        </div>
      </div>
